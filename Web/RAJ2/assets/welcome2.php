  ...
  <div id="test4" class="col s12">
    <table class="highlight">
      ...
      <tbody>
        <tr>
          <?php
          $sql4="SELECT * FROM `patient`,`appoinment` WHERE id=pid and day='thur'";
          $result4=$con->query($sq4);
          while($ro4=$result4->fetch_assoc()):
          ?>
          <td><?php echo $row4['patient_name'];?></td>
  ...
  <table class="highlight">
    ...
    <tbody>
      <tr>
        ...
        ?>
        <td><?php echo $row5['patient_name'];?></td>
